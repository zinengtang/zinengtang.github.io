...
def authors_html(auths):
    ...
    for a in auths:
        ...
        if a['n'] == 'Zineng Tang':
            ...
            parts.append(nm)  # co-author homepages intentionally not linked
    return ', '.join(parts)
...
<div class="wrap">
  ...
  <main>
    <section id="about">
      ...
      <div class="bio">
        <p>I am a Ph.D. student at UC Berkeley (BAIR), advised by Alane Suhr. Before Berkeley, I had wonderful experiences working with Mohit Bansal at <a href="https://nlp.cs.unc.edu/" target="_blank" rel="noopener">UNC-NLP</a> / <a href="https://murgelab.cs.unc.edu/" target="_blank" rel="noopener">MURGe-Lab</a> and with Ziyi Yang at Microsoft. I did my undergrad at UNC Chapel Hill.</p>
      </div>
    </section>
...
{pubs}
    ...
    <section id="interests">
      ...
      <div class="bio">
        <p>Outside of research, I spend my time on music production and video games.</p>
      </div>
    </section>
  </main>
